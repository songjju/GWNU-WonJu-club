  ...
  const fetchMyClubList = async () => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/club_introduce/myclub_list/`,
        {
          headers: {
    ...
    <div className="my-page" style={{ padding: "80px" }}>
      ...
      <div className="my-category-container" style={{ padding: "30px" }}>
        <div className="category_btn">
          <NavLink
            ...
            to="/"
            className={({ isActive }) =>
              isActive ? "my-category-item active-link" : "my-category-item"
            }
          >
            홈
          </NavLink>
          <NavLink
            to="/mypage/edit-information"
            className={({ isActive }) =>
              isActive ? "my-category-item active-link" : "my-category-item"
            }
          >
      ...
      <div>
        <Routes>
          ...
          <Route
            path="my-club"
            element={<MyClubPage myClubList={myClubList} />}
          />
        </Routes>
      </div>
    </div>
