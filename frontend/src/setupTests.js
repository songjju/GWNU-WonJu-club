...
// Chart.js 완전 모킹 - ClubAnalytics 컴포넌트 때문에 필요
jest.mock("chart.js", () => ({
...
// 전역 컴포넌트 모킹 제거 - 개별 테스트에서 필요시 모킹하도록 변경

// ReactBootstrap 모킹 - 기존 코드 개선
jest.mock("react-bootstrap", () => {
  ...
  // Carousel 컴포넌트 개선된 모킹
  const Carousel = ({ children, interval, ...props }) =>
    mockReact.createElement(
      "div",
      {
  ...
  return {
    ...
    DropdownToggle: ({ children, caret, ...props }) => {
      ...
      return mockReact.createElement(
        "button",
        { "data-testid": "dropdown-toggle", ...restProps },
        children
      );
    },
    ...
    DropdownItem: ({ children, divider, ...props }) => {
      if (divider) {
        return mockReact.createElement("hr", {
...
jest.mock("reactstrap", () => {
  ...
  return {
    ...
    ModalHeader: ({ children, toggle, ...props }) => {
      ...
      return mockReact.createElement(
        "div",
        { "data-testid": "modal-header", ...restProps },
        children
      );
    },
    ModalBody: ({ children, ...props }) =>
